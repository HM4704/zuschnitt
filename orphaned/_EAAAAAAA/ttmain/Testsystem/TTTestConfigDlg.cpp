	...
	: CDialog(CTTTestConfigDlg::IDD, pParent)
{
	...
	m_strTestDir = _T("");
	m_strTestFile = _T("");
	m_bTestFuellung = FALSE;
	m_bTestProfil = FALSE;
	m_bTestFuellung600 = FALSE;
	m_bTestProfil600 = FALSE;
	//}}AFX_DATA_INIT
}
...
void CTTTestConfigDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_TEST_FUELLUNG, m_bTestFuellung);
	DDX_Check(pDX, IDC_TEST_PROFIL, m_bTestProfil);
	DDX_Check(pDX, IDC_TEST_FUELLUNG600, m_bTestFuellung600);
	DDX_Check(pDX, IDC_TEST_PROFIL600, m_bTestProfil600);
	//}}AFX_DATA_MAP
}
...
void CTTTestConfigDlg::CopyValues(BOOL bLoad)
{
    if (bLoad == TRUE)
    {
        ...
        m_bTestProfil = m_Config.ribfCheck[0].bf.bProfile;
        m_bTestFuellung = m_Config.ribfCheck[0].bf.bFuellung;
        m_bTestProfil600 = m_Config.ribfCheck[1].bf.bProfile;
        m_bTestFuellung600 = m_Config.ribfCheck[1].bf.bFuellung;
    ...
    else
    {
        ...
        m_Config.ribfCheck[0].bf.bProfile = m_bTestProfil;
        m_Config.ribfCheck[0].bf.bFuellung = m_bTestFuellung;
        m_Config.ribfCheck[1].bf.bProfile = m_bTestProfil600;
        m_Config.ribfCheck[1].bf.bFuellung = m_bTestFuellung600;
