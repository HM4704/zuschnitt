...
void CTTSize::Serialize( CArchive& archive )
{
...
void CTorDoor::Serialize( CArchive& archive )
{
...
void CFlParam::MySerialize(CArchive& archive)
{
    if ( archive.IsStoring() )
    {
...
void CProfileElem::MySerialize(CArchive& archive)
{
    int iDir, iTyp;
    if ( archive.IsStoring() )
    {
...
void CHolzElement::MySerialize(CArchive& archive)
{
    if ( archive.IsStoring() )
    {
...
void CRiegelElement::MySerialize(CArchive& archive)
{
    if ( archive.IsStoring() )
    {
