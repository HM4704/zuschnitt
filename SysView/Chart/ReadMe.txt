========================================================================
		ActiveX Control DLL : CHART
========================================================================

ControlWizard has created this project for your CHART ActiveX Control
...
that make up your CHART ActiveX Control DLL.
...
ChartCtl.h
	This file contains the declaration of the CChartCtrl C++ class.

ChartCtl.cpp
	This file contains the implementation of the CChartCtrl C++ class.

ChartPpg.h
	This file contains the declaration of the CChartPropPage C++ class.

ChartPpg.cpp
	This file contains the implementation of the CChartPropPage C++ class.

ChartCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CChartCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Chart.rc.
