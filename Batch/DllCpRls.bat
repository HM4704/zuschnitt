...
xcopy /D /Y d:\User\HMO\projekte\vc++\Components\RegMan\vs2005\Regman\Release\RegMan.lib .\Release\*.*
xcopy /D /Y d:\user\hmo\projekte\vc++\Components\RegMan\vs2005\Regman\Release\RegMan.dll .\Release\*.*
