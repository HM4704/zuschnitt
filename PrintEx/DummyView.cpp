...
void CDummyView::SetPrintDialog(CPrintPreviewDialog* pDialog)
{
	m_pDialog = pDialog;
}
...
BOOL CDummyView::OnPreparePrinting(CPrintInfo* pInfo)
{
	if (m_pDialog)
	{
		return m_pDialog->OnPreparePrinting(pInfo);
	}
	return FALSE;
}
...
void CDummyView::OnBeginPrinting(CDC* pDC, CPrintInfo* pInfo)
{
	if (m_pDialog)
	{
		m_pDialog->OnBeginPrinting(pDC, pInfo);
	}
}
...
void CDummyView::OnPrepareDC(CDC* pDC, CPrintInfo* pInfo)
{
	if (m_pDialog)
	{
		m_pDialog->OnPrepareDC(pDC, pInfo);
	}
}
...
void CDummyView::OnEndPrinting(CDC* pDC, CPrintInfo* pInfo)
{
	if (m_pDialog)
	{
		m_pDialog->OnEndPrinting(pDC, pInfo);
	}
}
